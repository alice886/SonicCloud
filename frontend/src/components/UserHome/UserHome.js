    ...
    if (!sessionUser) {
        return (
            <div className='public-home'>
                ...
                <img src='https://va.sndcdn.com/bg/soundcloud:sounds:416933784/VisualTrack_Oshun_01_1.jpg' className="landing-pic"></img>
                <h3>Hear what’s trending for free in the SoundCloud community</h3>
                <div className="landing-box">
                    <img src='https://a-v2.sndcdn.com/assets/images/sc_landing_header_web_featured_artists-8081257b.jpg' className="landing-box-pic"></img>
                    <div className='public-down'>
